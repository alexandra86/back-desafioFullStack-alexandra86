...
const listClientsController = (_, response) => __awaiter(void 0, void 0, void 0, function* () {
...
const retrieveClientsController = (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { client, contacts } = yield (0, retrieveClient_service_1.retrieveClientService)(id);
...
const updateClientController = (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    const clientData = request.body;
    const id = parseInt(request.params.id);
    const updateClient = yield (0, updateClient_service_1.updateClientService)(clientData, id);
...
const deleteClientController = (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    const id = parseInt(request.params.id);
    yield (0, deleteClient_service_1.deleteClientService)(id);
