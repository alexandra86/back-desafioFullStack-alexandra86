...
const updateClientService = (newClientData, id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const updatedClient = clients_schema_1.returnClientSchema.parse(client);
