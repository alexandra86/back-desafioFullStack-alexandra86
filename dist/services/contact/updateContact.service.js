...
const updateContactService = (newContactData, id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const updatedContact = contact_schema_1.returnContactSchema.parse(contact);
