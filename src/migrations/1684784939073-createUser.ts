...
export class CreateUser1684784939073 implements MigrationInterface {
    name = 'CreateUser1684784939073'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."contacts_gender_enum" AS ENUM('male', 'female', 'no binary', 'I prefer not to say')`);
        await queryRunner.query(`CREATE TABLE "contacts" ("id" SERIAL NOT NULL, "fullName" character varying(127) NOT NULL, "email" character varying(127) NOT NULL, "phone" character varying(45) NOT NULL, "registerDate" TIMESTAMP NOT NULL DEFAULT now(), "gender" "public"."contacts_gender_enum" NOT NULL DEFAULT 'I prefer not to say', "clientId" integer, CONSTRAINT "PK_b99cd40cfd66a99f1571f4f72e6" PRIMARY KEY ("id"))`);
